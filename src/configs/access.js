...
export const AccessRoleAdminDispanser = Access.dispanser["Администрирование АПЛ"] |
...
export const accessDispPage = [
    {
        unit: 1,
        access: AccessRoleDoct | AccessRoleRegistrator | AccessRoleASU | AccessRoleUKL | AccessRoleAdminDispanser
    },
    {
        unit: 2,
        access: AccessRoleDoct | AccessRoleRegistrator | AccessRoleASU | AccessRoleUKL | AccessRoleAdminDispanser
...
export const accessModule = {
    dispanser: {
        ...
        history: {
            access: AccessRoleASU | AccessRoleDoct | AccessRoleRegistrator | AccessRoleAdminDispanser,
            unit: unitDisp,
        },
        uchet: {
            access: AccessRoleASU | AccessRoleDoct | AccessRoleRegistrator | AccessRoleAdminDispanser,
